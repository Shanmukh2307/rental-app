...
export const api = createApi({
  ...
  endpoints: (build) => ({
   ...
   updateTenantSettings : build.mutation <Tenant, Partial<Tenant> & {cognitoId: string}>({
    ...
    updateManagerSettings : build.mutation <Manager, Partial<Manager> & {cognitoId: string}>({
